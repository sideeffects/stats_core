...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MachineConfig', fields ['machine', 'config_hash']
        db.create_unique(u'stats_main_machineconfig', ['machine_id', 'config_hash'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'MachineConfig', fields ['machine', 'config_hash']
        db.delete_unique(u'stats_main_machineconfig', ['machine_id', 'config_hash'])
