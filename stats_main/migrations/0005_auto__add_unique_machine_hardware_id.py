...
class Migration(SchemaMigration):    
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Machine', fields ['hardware_id']
        db.create_unique(u'stats_main_machine', ['hardware_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Machine', fields ['hardware_id']
        db.delete_unique(u'stats_main_machine', ['hardware_id'])
