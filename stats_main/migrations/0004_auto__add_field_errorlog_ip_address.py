...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ErrorLog.ip_address'
        db.add_column(u'stats_main_errorlog', 'ip_address',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ErrorLog.ip_address'
        db.delete_column(u'stats_main_errorlog', 'ip_address')
